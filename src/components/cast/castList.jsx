        ...
        return(
            <div className="cast-list-container">
                ...
                {props.cast.map(person => {
                    return(
                        <CastPerson image={person.profile_path} name={person.name} character={person.character} id={person.id}/>
                    )
                })}
            </div>
        )
                ...
                return(
                        <div className="cast-list-container">
                            ...
                            {props.crew[key].map(person => {
                                return(
                                    <CastPerson image={person.image} name={person.name} jobs={person.job} id={person.id} />
                                )
                            })}
                        </div>
                    )
