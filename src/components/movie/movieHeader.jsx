...
const MovieHeader = (props)=> {
    if (props.movie) return(
        <div style={props.movie.backdrop_path && {backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(https://image.tmdb.org/t/p/original" + props.movie.backdrop_path + ")"}} className="header-container">
