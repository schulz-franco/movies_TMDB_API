const MovieMoreInfo = (props)=> {
    if (props.movie) return(
        <div className="more-info">
            ...
            <span className="valor">{(props.movie.budget != 0) ? ("$" + props.movie.budget) : "Without budget"}</span>
            <span className="data">Revenue</span>
            <span className="valor">{(props.movie.revenue != 0) ? ("$" + props.movie.revenue) : "Without revenue"}</span>
        </div>
    )
}
